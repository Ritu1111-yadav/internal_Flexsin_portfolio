...
exports.findPagination = async (req, res) => {
  ...
  const paginated = await User.paginate(query, {
    page,
    limit,
    lean: true,
    sort: { updatedAt: "desc" },
  ...
  User.find({ email: req.body.email })
    .then((data) => {
      ...
      var transporter = nodemailer.createTransport({
        service: "gmail",
        auth: {
          user: "bhavana.goethe@gmail.com",
          pass: "voasberbcwsyudsb",
        },
      });
      var mailOptions = {
        from: "bhavana.goethe@gmail.com",
        to: "divyanshithakkar0421@gmail.com",
        subject: "Winners Shortlist for the 2022 Goethe Quiz",
        ...
        html: `
            <div class="main-container">
                <div class="container"
                    style="width: 80%; margin: 0 auto; background: #fff; padding: 30px; border-radius: 5px; box-shadow: 0 0 10px 0 rgba(0, 0, 0, 0.1); margin-right: auto; margin-left: 10px;">
                <img src="https://ia904705.us.archive.org/25/items/web-capture-16-11-2022-235217-localhost/Web%20capture_16-11-2022_235217_localhost.jpeg" alt="Flexsin Logo" class="logo" width="700px" height="1000px">
                </div>
            </div>
`,
      };
